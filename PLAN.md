...
| ID | 任务 | 优先级 | 状态 | Commit |
| --- | --- | --- | --- | --- |
| CS-01 | 冷启动验证 | 必做前置 | `[x]` | 425708b |
| T01 | 项目骨架与质量门禁 | P0 | `[x]` | 471b4ee |
| T02 | 领域模型与状态机 | P0 | `[x]` | 8bd1174 |
| T03 | SQLite schema 与仓储 | P0 | `[x]` | d565c96 |
| T04 | LLM 抽象与 fake LLM | P0 | `[x]` | 1106264 |
...
| T11 | 预设与自定义选择 | P0 | `[x]` | PR-05 |
| T12 | 分支与记忆快照恢复 | P1 | `[x]` | PR-05 |
| T13 | 动态故事弧与摘要 | P1 | `[x]` | PR-05 |
| T14 | 创建向导和书架 | P0 | `[x]` | PR-06 |
| T15 | 流式阅读器和自动续写 | P0 | `[x]` | PR-06 |
| T16 | 选择、暂停、恢复和分支 UI | P0/P1 | `[x]` | PR-06 |
| T17 | 匿名会话隔离 | P0 | `[x]` | PR-07 |
| T18 | 凭据与日志脱敏 | 必做 | `[x]` | PR-07 |
| T19 | 速率、并发和成本护栏 | 必做 | `[x]` | PR-07 |
| T20 | Markdown 导出 | P1 | `[x]` | PR-07 |
| T21 | 端到端测试与演示夹具 | 必做 | `[x]` | PR-08 |
| T22 | Docker 分发 | 必做 | `[x]` | PR-08 |
| T23 | GitLab CI 与 secret scan | 必做 | `[x]` | PR-08 |
| T24 | 部署、README 与最终验收 | 必做 | `[x]` | PR-08 |

**进度汇总：** 24/24 任务完成（100%）✅ 全部任务完成 | PR-08（T21-T24）收尾
